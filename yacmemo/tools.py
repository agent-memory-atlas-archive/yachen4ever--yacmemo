...
closures. The tool set, docstrings, and error phrasing are identical across
transports — agents see the same surface no matter how they connect.
"""
...
def register_tools(mcp: FastMCP, store: Store, searcher: Searcher) -> None:
